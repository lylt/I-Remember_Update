		...
		btnCreate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!utittle.equals("")) {
					...
					dataHelper.close();
					Toast.makeText(MainActivity.this, "updated successfuly",
							30000).show();
			...
			public void onClick(View v) {
				...
				if (isInternetPresent) {
					if (gps.canGetLocation()) {
						...
						String mapPath = "http://maps.google.com/maps?q=+"
								+ latitude + "," + longitude + "&t=m&z=7";
						Intent mIntent = new Intent(getApplicationContext(),
					...
					if (gps.canGetLocation()) {
						...
						// "no Internet connection-your longitude: "
						...
						alertDialog
								.setMessage("no InternetConnection, your longitude: "
										+ longitude
										+ ", your latitude: "
										+ latitude);
						alertDialog.setButton("OK",
